...
Отныне этот репозиторий открыт для всех, вы можете использовать его в своих нуждах как хотите, можете указать нас как авторов хз, нам пох пох реально.
...
### Список кукол
    ...
    Кукла - Телохранитель
    Кукла - Утка
Учтите, что ~~Найс скрытый кибербуллинг, чел~~ название нужно копировать из строки полностью, например: `Кукла - утка`
## Спонсорские модели
